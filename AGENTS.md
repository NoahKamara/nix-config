...
This file is intentionally short and only covers non-obvious, repo-specific pitfalls. When you repeatedly misunderstand something or fail at a task, consider editing the "Repeated Failure Patterns" section.
...
- Follow `nix-best-practices` skill for flake and overlay patterns.
